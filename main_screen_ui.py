...
"")
        ...
        self.studentButton1.setMinimumSize(QSize(0, 40))
        self.studentButton1.setMaximumSize(QSize(16777215, 40))
        icon1 = QIcon()
        ...
        self.programButton1.setMinimumSize(QSize(0, 40))
        self.programButton1.setMaximumSize(QSize(16777215, 40))
        icon2 = QIcon()
        ...
        self.collegeButton1.setMinimumSize(QSize(0, 40))
        self.collegeButton1.setMaximumSize(QSize(16777215, 40))
        icon3 = QIcon()
        ...
        self.studentButton2.setMinimumSize(QSize(0, 40))
        self.studentButton2.setMaximumSize(QSize(16777215, 40))
        font = QFont()
        ...
        self.programButton2.setMinimumSize(QSize(0, 40))
        self.programButton2.setMaximumSize(QSize(16777215, 40))
        font1 = QFont()
        ...
        self.collegeButton2.setMinimumSize(QSize(0, 40))
        self.collegeButton2.setMaximumSize(QSize(16777215, 40))
        ...
        self.comboBox_29.setMinimumSize(QSize(100, 28))
        ...
        self.lineEdit_19.setMinimumSize(QSize(220, 0))
        self.lineEdit_19.setMaximumSize(QSize(220, 16777215))

        self.horizontalLayout_11.addWidget(self.lineEdit_19)

        self.refreshStudentButton = QPushButton(self.frame_5)
        self.refreshStudentButton.setObjectName(u"refreshStudentButton")
        sizePolicy7 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        sizePolicy7.setHorizontalStretch(0)
        sizePolicy7.setVerticalStretch(0)
        sizePolicy7.setHeightForWidth(self.refreshStudentButton.sizePolicy().hasHeightForWidth())
        self.refreshStudentButton.setSizePolicy(sizePolicy7)
        icon5 = QIcon()
        icon5.addFile(u":/imgs/imgs/refresh_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.refreshStudentButton.setIcon(icon5)
        self.refreshStudentButton.setIconSize(QSize(20, 20))
        ...
        self.horizontalSpacer_11 = QSpacerItem(50, 25, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.widget_5.setMinimumSize(QSize(50, 0))
        ...
        self.studentTable.setFocusPolicy(Qt.NoFocus)
        self.studentTable.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.studentTable.setSelectionMode(QAbstractItemView.NoSelection)
        self.studentTable.setSelectionBehavior(QAbstractItemView.SelectItems)
        ...
        self.comboBox_30.setMinimumSize(QSize(100, 28))
        self.comboBox_30.setMaximumSize(QSize(100, 28))
        ...
        self.lineEdit_20.setMinimumSize(QSize(220, 0))
        self.lineEdit_20.setMaximumSize(QSize(220, 16777215))

        self.horizontalLayout_13.addWidget(self.lineEdit_20)

        self.refreshProgramButton = QPushButton(self.frame_6)
        self.refreshProgramButton.setObjectName(u"refreshProgramButton")
        sizePolicy7.setHeightForWidth(self.refreshProgramButton.sizePolicy().hasHeightForWidth())
        self.refreshProgramButton.setSizePolicy(sizePolicy7)
        self.refreshProgramButton.setIcon(icon5)
        self.refreshProgramButton.setIconSize(QSize(20, 20))
        ...
        self.horizontalSpacer_13 = QSpacerItem(50, 25, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.widget_13.setMinimumSize(QSize(50, 0))
        ...
        self.programTable.setFocusPolicy(Qt.NoFocus)
        self.programTable.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.programTable.setTabKeyNavigation(True)
        self.programTable.setProperty(u"showDropIndicator", True)
        self.programTable.setSelectionMode(QAbstractItemView.NoSelection)
        self.programTable.setSelectionBehavior(QAbstractItemView.SelectItems)
        ...
        self.comboBox_32.setMinimumSize(QSize(100, 28))
        self.comboBox_32.setMaximumSize(QSize(100, 28))
        ...
        self.lineEdit_22.setMinimumSize(QSize(220, 0))
        self.lineEdit_22.setMaximumSize(QSize(220, 16777215))

        self.horizontalLayout_16.addWidget(self.lineEdit_22)

        self.refreshCollegeButton = QPushButton(self.frame_12)
        self.refreshCollegeButton.setObjectName(u"refreshCollegeButton")
        sizePolicy7.setHeightForWidth(self.refreshCollegeButton.sizePolicy().hasHeightForWidth())
        self.refreshCollegeButton.setSizePolicy(sizePolicy7)
        self.refreshCollegeButton.setIcon(icon5)
        self.refreshCollegeButton.setIconSize(QSize(20, 20))
        ...
        self.horizontalSpacer_15 = QSpacerItem(50, 25, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        self.widget_14.setMinimumSize(QSize(50, 0))
        self.widget_14.setMaximumSize(QSize(50, 16777215))
        ...
        self.collegeTable.setFocusPolicy(Qt.NoFocus)
        ...
        self.menuButton.toggled.connect(self.full_menu_widget.setVisible)
        self.menuButton.toggled.connect(self.icon_only_widget.setHidden)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_29.setItemText(0, QCoreApplication.translate("MainWindow", u"Search by", None))
        self.comboBox_29.setItemText(1, QCoreApplication.translate("MainWindow", u"ID Number", None))
        self.comboBox_29.setItemText(2, QCoreApplication.translate("MainWindow", u"First Name", None))
        self.comboBox_29.setItemText(3, QCoreApplication.translate("MainWindow", u"Last Name", None))
        self.comboBox_29.setItemText(4, QCoreApplication.translate("MainWindow", u"Gender", None))
        ...
        self.comboBox_30.setItemText(0, QCoreApplication.translate("MainWindow", u"Search by", None))
        self.comboBox_30.setItemText(1, QCoreApplication.translate("MainWindow", u"Program Code", None))
        ...
        self.comboBox_32.setItemText(0, QCoreApplication.translate("MainWindow", u"Search by", None))
